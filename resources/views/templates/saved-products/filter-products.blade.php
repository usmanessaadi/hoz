...
<div id="sp-c" style="display: none;">
    @forelse ($saved_products as $saved_product)
        <div class="order_info-product saved_product" id="sv_prd-{{$saved_product->product_detail_id}}">
            ...
            <div class="saved_product_actions ">
                ...
                <a class="remove-from-savedProducts" href="#{{$saved_product->product_detail_id}}">
                    <i class="fa fa-trash mr-2"aria-hidden="true"></i>
                    Remove
                </a>
                {{--<form id="remove_product-form-{{$saved_product->product_detail_id}}" action="{{ route('remove_product',$saved_product->product_detail_id) }}" method="POST" style="display: none;">--}}
                    {{--@csrf--}}
                {{--</form>--}}
            </div>
        </div>

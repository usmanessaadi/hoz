                            ...
                            <div class="carousel-item  active">
                                    <div class="col-md-2 col-sm-6 mx-1 shop_card">
                                        <div class="shop_card_header">
                                            ...
                                            <img style="width:140px" class='related_image' src="{{PRODUCT_DISPLAY_PATH.$relatedProduct->images[0]->image_url}}" alt="">
                                        </div>
                                        <div class="line"></div>
                                        <div class="shop_card_bottom">
                                            <p class="product_brand">{{$relatedProduct->get_product('brand')}}</p>
                                            <h3 class="product_name">{{$relatedProduct->get_product('product_name')}}</h3>
                                            <div class="product_price">
                                                <p>${{ number_format($relatedProduct->SellingPrice, 2, ',', ' ')}} @if($relatedProduct->discount > 0) <span class="original_product_price">${{number_format($relatedProduct->price, 2, ',', ' ')}}</span> @endif</p>

                                                <p class="installement">
                                                    or 3 installments of
                                                    <span class="installement_price">
                                                            ${{ number_format($relatedProduct->SellingPrice/3, 2, ',', ' ')}}
                                                    </span>
                                                    with
                        ...
                        @endforeach
                            <!-- <div class="carousel-item  active">
                                <div class="col-md-2 col-sm-6 mx-1 shop_card">
                                    ...
                                    <div class="line"></div>
                                    <div class="shop_card_bottom">
                                        <p class="product_brand">Samsung 2</p>
                            ...
                            <!-- <div class="carousel-item  active">
                                <div class="col-md-2 col-sm-6 mx-1 shop_card">
                                    ...
                                    <div class="line"></div>
                                    <div class="shop_card_bottom">
                                        <p class="product_brand">Samsung 1</p>
                                        <h3 class="product_name">Deadbolt Lock SHP-DS510</h3>
                                        <div class="product_price">
                                            <p>$359 <span class="original_product_price">$459</span></p>
                                            <p class="installement">
